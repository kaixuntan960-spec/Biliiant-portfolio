    ...
    <div className={`transition-all duration-700 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{ transitionDelay: `${index * 0.15}s` }}>
      <div className="flex items-start" style={{ gap: "var(--space-6)" }}>
        ...
        <div
          ...
          style={{ perspective: "1000px", marginBottom: "var(--space-6)" }}
        ...
        >
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-start" style={{ gap: "var(--space-10)" }}>
            <div className="flex-shrink-0">
              ...
              >
                {siteContent.about.profile.avatarImage && !avatarLoadFailed ? (
                  <img
                    src={siteContent.about.profile.avatarImage}
              ...
              >
                <div className="flex items-start justify-between" style={{ marginBottom: "var(--space-4)" }}>
                  <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-3)" }}>
                    ...
                    <h4 className="font-bold text-foreground" style={{ fontSize: "var(--text-md)" }}>
                      {edu.school}
                    </h4>
                  </div>
                  <span className="text-muted-foreground flex-shrink-0" style={{ fontSize: "var(--text-xs)" }}>
                    {edu.period}
                  </span>
                </div>
                <p className="text-primary" style={{ fontSize: "var(--text-sm)", marginBottom: "var(--space-2)" }}>
                  {edu.degree}
                </p>
                <p style={{ fontSize: "var(--text-xs)", marginBottom: "var(--space-4)", color: "var(--chart-4)" }}>
                  {edu.gpa}
                </p>
                <p className="text-muted-foreground leading-relaxed" style={{ fontSize: "var(--text-sm)" }}>
                  {edu.desc}
