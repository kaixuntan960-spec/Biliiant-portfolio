    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <span style={{ color: "var(--primary-foreground)" }}>{siteContent.nav.brand.markText}</span>
          </div>
          <span
            className="font-semibold tracking-widest uppercase"
            style={{ fontSize: "var(--text-xs)", color: "var(--foreground)" }}
          >
            {siteContent.nav.brand.name}
          </span>
        </div>
        ...
        <div className="hidden xl:flex items-center" style={{ gap: "var(--space-4)" }}>
          <button
            ...
            style={{
              ...
              boxShadow: mode === "light" ? "0 6px 16px rgba(245, 158, 11, 0.22)" : "0 6px 16px rgba(99, 102, 241, 0.22)",
          ...
          <a
            ...
            className="font-medium transition-all duration-300 hover:shadow-glow hover:scale-105"
            style={{
